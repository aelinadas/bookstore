<%-- 
    Document   : view
    Created on : May 28, 2020, 11:49:08 AM
    Author     : aelinadas
--%>
...
<html>
    ...
    <body>
        ...
        <label>Your Full Name </label>${sessionScope.buyer.fname} ${sessionScope.buyer.lname}
        <br/>
        <label>Your UserName </label>${sessionScope.buyer.email}
        <br/>
        <br/>
